        ...
        <tr>
            <td>
                ...
                if ($schedule_count > 0)
                {
                    ...
                    <input type="button" class="button action" value="Apply" onclick="DupPro.Schedule.Copy()">
                <?php
                }
                else
                {
                    ...
                    <input type="button" class="button action" value="Apply" onclick="DupPro.Schedule.Copy()"  disabled="disabled">
				<?php } ?>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="padding-top:0px; padding-bottom:10px;">
                ...
                <!--                <div id="repeat-weekly-area" class="repeater-area">
                                    ...
                                    <table>
                                        <tr>
                                            <td><input <?php DUP_PRO_U::echo_checked($schedule->is_day_set('mon')); ?> value="mon" name="weekday[]" type="checkbox" id="repeat-monthly-mon" required /> <label for="repeat-monthly-mon"><?php _e("Monday"); ?></label> </td>
                                            <td><input <?php DUP_PRO_U::echo_checked($schedule->is_day_set('tue')); ?> value="tue" name="weekday[]" type="checkbox" id="repeat-monthly-tue" /> <label for="repeat-monthly-tue"><?php _e("Tuesday"); ?></label></td>
                                            <td><input <?php DUP_PRO_U::echo_checked($schedule->is_day_set('wed')); ?> value="wed"  name="weekday[]" type="checkbox" id="repeat-monthly-wed" /> <label for="repeat-monthly-wed"><?php _e("Wednesday"); ?></label></td>
                                            <td><input <?php DUP_PRO_U::echo_checked($schedule->is_day_set('thu')); ?>  value="thu" name="weekday[]" type="checkbox" id="repeat-monthly-thu" /> <label for="repeat-monthly-thu"><?php _e("Thursday"); ?></label></td>
                                        </tr>
                                        <tr>
                                            <td><input <?php DUP_PRO_U::echo_checked($schedule->is_day_set('fri')); ?> value="fri" name="weekday[]" type="checkbox" id="repeat-monthly-fri" /> <label for="repeat-monthly-fri"><?php _e("Friday"); ?></label> </td>
                                            <td><input <?php DUP_PRO_U::echo_checked($schedule->is_day_set('sat')); ?> values="sat" name="weekday[]" type="checkbox" id="repeat-monthly-sat" /> <label for="repeat-monthly-sat"><?php _e("Saturday"); ?></label> </td>
                                            <td><input <?php DUP_PRO_U::echo_checked($schedule->is_day_set('sun')); ?> value="sun" name="weekday[]" type="checkbox" id="repeat-monthly-sun" /> <label for="repeat-monthly-sun"><?php _e("Sunday"); ?></label> </td>
                                            <td></td>
                                        </tr>
                                    </table>
                                </div>-->
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <select name="_start_time" style="margin-top:-2px; height:27px">
                    ...
                    $mins = 0;  //rsr temp till i confirm with cory
...
<?php _e("Current Server Time Stamp is"); ?>&nbsp;
